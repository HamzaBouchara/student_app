...
<html lang="en">
	...
	<!--begin::Body-->
	{{-- class removed aside-fixed aside-secondary-enabled --}}
	<body id="kt_body" style="background-image: url()" class="header-fixed header-tablet-and-mobile-fixed">
		<!--begin::Main-->
		<!--begin::Root-->
						...
						<div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
							...
							<div class="d-flex d-lg-none align-items-center ms-n2 me-2">
								...
								<a href="#" class="d-flex align-items-center">
									<img alt="Logo" src="assets/media/logos/logo_imbt.svg" class="h-90px" />
								</a>
								<!--end::Logo-->
							</div>
							<!--end::Wrapper-->
							...
							<div class="card">
								...
								<div class="card-header">
									...
									<div class="card-toolbar">
										<button class="btn btn-flex btn-primary" data-kt-calendar="add">Ajouter un événement</button>
									</div>
								</div>
								<!--end::Card header-->
								<!--begin::Card body-->
